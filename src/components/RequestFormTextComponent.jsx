...
export default class RequestFormTextComponent extends Component {
    ...
    getVariable(iv) {
        ...
        return (<input type={iv.type} value={iv.value === undefined ? '': iv.value} name={iv.name} key={iv.name} onChange={this.props.handleChange} placeholder={iv.hint !== null || iv.hint !== undefined ? iv.hint : ''}></input>);
    }
